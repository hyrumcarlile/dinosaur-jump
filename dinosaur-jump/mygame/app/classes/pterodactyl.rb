class Pterodactyl < AnimatedObject
  ...
  def initialize(w: 0, h: 0, x: Grid.w, y: 0, x_velocity: DEFAULT_RUNNING_SPEED - 4, y_velocity: 0, x_acceleration: 0, y_acceleration: 0, gravity: 0, sprite_change_frequency: 5, current_sprite_index: 0, max_sprite_index: 4, action: :flying)
    ...
    @y = [70, 70, 70, 120, 120, 180].sample + GROUND_LEVEL
  end
